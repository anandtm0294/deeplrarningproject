...
class DataIngestion:
    ...
    def __init__(self, data_ingestion_config: DataIngestionConfig):
        self.data_data_ingestion_config = DataIngestionConfig
    ...
    def get_data_from_s3(self):
        try:
            ...
            self.s3.sync_folder_from_s3(
                folder=self.data_data_ingestion_config.data_path,
                bucket_name=self.data_ingestion_config.bucket_name,
                bucket_folder_name=self.data_ingestion_config.s3_data_folder,
            )

            logging.info("Exit the get_data_from_s3 method of Data ingestion class")
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            data_ingestion_artifact:DataIngestionArtifact = DataIngestionArtifact(
                train_file_path=self.data_data_ingestion_config.train_data_path,
                test_file_path=self.data_data_ingestion_config.test_data_path,
